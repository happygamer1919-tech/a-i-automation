...
const ro: Dict = {
  ...
  tier1_desc: 'Audităm fluxurile tale de lucru, identificăm ineficiențele și configurăm instrumentele potrivite (Notion, Slack, Trello, Miro sau ce se potrivește operațiunii tale).',
  ...
  tier2_desc: 'Construim și implementăm boți și automatizări: boți de onboarding, programări, FAQ, calificare lead-uri. Toate adaptate procesului tău specific.',
...
const ru: Dict = {
  ...
  tier1_desc: 'Проводим аудит рабочих процессов, выявляем неэффективности и настраиваем подходящие инструменты (Notion, Slack, Trello, Miro или то, что подходит вашей операции).',
  ...
  why_1: 'Мы не продаём универсальные решения. Мы строим на ваших реальных процессах',
  ...
  why_4: 'Постоянная поддержка и оптимизация, а не просто доставка и уход',
...
const en: Dict = {
  ...
  tier1_desc: 'We audit your workflows, identify inefficiencies, and set up the right tools (Notion, Slack, Trello, Miro, or whatever fits your operation).',
